...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graph ){
	  ...
	  function exportJson(){
	    ...
	    console.log('before ' + jsonExportFileName)
		//candidate_graph - check if url conatins .json in middle
	    //if ( !jsonExportFileName.endsWith(".json") )
		if ( !jsonExportFileName.includes(".json") )
	      jsonExportFileName += ".json";
	    exportJsonButton.attr("href", dataURI)
	      .attr("download", jsonExportFileName);
		console.log('after ' + jsonExportFileName)
	  }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {module.exports = function ( graph ){
	  ...
	  //var DEFAULT_JSON_NAME =  "iri=https://dev.simplify-ai.com/candidategraph/ontology_json/?ID="+ d3.select("#iri-converter-input").node().value   // "ontology_json"//"foaf"; // This file is loaded by default
	  var DEFAULT_JSON_NAME =  "graph.json?id=" + d3.select("#iri-converter-input").node().value + "&source=" + d3.select("#source").node().value  // "ontology_json"//"foaf"; // This file is loaded by default
	  console.log(DEFAULT_JSON_NAME)
	  ...
	  loadingModule.parseUrlAndLoadOntology = function ( storeCache ){
		...
		console.log(ontologyIdentifierFromURL)
	...
	//2] File Upload to OWL2VOWL Converter
	  ...
	  function loadPresetOntology( ontology ){
	    ...
	    if ( ontology.indexOf("new_ontology") !== -1 ) {
		  ...
		  f2r = "./static/data/new_ontology.json";
	    ...
	    if ( ontologyMenu.cachedOntology(ontology) ) {
		  ...
		  //var fileToRead = "./static/data/" + ontology; //+ ".json";
