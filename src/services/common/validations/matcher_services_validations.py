...
class MatcherServicesValidations(BaseModel):
    """Matcher Services Body """
...
class ResumesToResumeValidations(BaseModel):
    """Resumes To Resume"""
    ...
    @validator("no_of_matches")
    def no_of_matches_must_be_string(cls, no_of_matches):
        """
        Custom validation message for no_of_matches
        :param v:
        :return:
    ...
    @validator("refresh_rate")
    def refresh_rate_must_be_string(cls, refresh_rate):
        """
        Custom validation message for refresh_rate
        :param v:
        :return:
...
class CandidatesToJobValidations(BaseModel):
    """Candidates To Job"""
    ...
    @validator("job_id")
    def job_id_must_be_string(cls, job_id):
        """
        Custom validation message for job_id
        :param v:
        :return:
